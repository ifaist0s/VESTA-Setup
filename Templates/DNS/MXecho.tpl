...
ID='12' RECORD='mail' TYPE='CNAME' PRIORITY='' VALUE='echo.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='13' RECORD='smtp' TYPE='CNAME' PRIORITY='' VALUE='echo.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='14' RECORD='pop' TYPE='CNAME' PRIORITY='' VALUE='echo.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
