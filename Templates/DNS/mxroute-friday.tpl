...
ID='9' RECORD='webmail' TYPE='CNAME' PRIORITY='' VALUE='friday.mxlogin.com.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='10' RECORD='mail' TYPE='CNAME' PRIORITY='' VALUE='friday.mxlogin.com.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='11' RECORD='www' TYPE='A' PRIORITY='' VALUE='%ip%' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='12' RECORD='@' TYPE='MX' PRIORITY='10' VALUE='friday.mxlogin.com.' SUSPENDED='no' TIME='%time%' DATE='%date%'
