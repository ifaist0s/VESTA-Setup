...
ID='12' RECORD='mail' TYPE='CNAME' PRIORITY='' VALUE='sunfire.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='13' RECORD='smtp' TYPE='CNAME' PRIORITY='' VALUE='sunfire.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='14' RECORD='pop' TYPE='CNAME' PRIORITY='' VALUE='sunfire.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='15' RECORD='imap' TYPE='CNAME' PRIORITY='' VALUE='sunfire.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='16' RECORD='webmail' TYPE='CNAME' PRIORITY='' VALUE='sunfire.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='17' RECORD='@' TYPE='MX' PRIORITY='10' VALUE='sunfire.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
...
ID='20' RECORD='x._domainkey' TYPE='TXT' PRIORITY='' VALUE='"v=DKIM1; k=rsa;"' SUSPENDED='no' TIME='%time%' DATE='%date%'
