...
ID='12' RECORD='mail' TYPE='CNAME' PRIORITY='' VALUE='shadow.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='16' RECORD='webmail' TYPE='CNAME' PRIORITY='' VALUE='shadow.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
ID='17' RECORD='@' TYPE='MX' PRIORITY='10' VALUE='shadow.mxrouting.net.' SUSPENDED='no' TIME='%time%' DATE='%date%'
